...
- [ ] v1.4 Safe Edit에서 draft/frontmatter 변경 전 diff preview 범위를 확정한다
...
다음 단계는 v1.4 Safe Edit다. 이 단계에서는 draft/frontmatter 같은 작은 수정만 다루고, 저장 전 diff preview를 먼저 보여준다.
